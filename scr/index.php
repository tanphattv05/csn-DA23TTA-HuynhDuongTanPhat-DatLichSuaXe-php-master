    ...
    <div class="grid">
        <div class="swiper">
            <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" navigation="true" space-between="30"
                ...
                <swiper-slide><img src="img/anh_suaxemay.jpg" alt=""></swiper-slide> <!-- id="mainslide"-->
                <swiper-slide><img src="img/anh_suaxemay4.jpg" alt=""></swiper-slide>
                <swiper-slide><img src="img/anh_suaxemay2.jpg" alt=""></swiper-slide>
                <swiper-slide><img src="img/anh_suaxemay3.jpg" alt=""></swiper-slide>
                <swiper-slide><img src="img/anh_suaxemay1.jpg" alt=""></swiper-slide>
            </swiper-container>
